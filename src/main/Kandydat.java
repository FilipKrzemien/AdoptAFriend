...
public class Kandydat {
	...
	public static void zapis(String spec, int k, Kandydat kandydat) throws IOException {
		...
		bw.write("------------ SCHRONISKO DLA ZWIERZĄT W KRAKOWIE ------------");
		bw.newLine();
		bw.write("------------ POTWIERDZENIE WYSŁANIA FORMULARZA -------------");
		bw.newLine();
		bw.newLine();
		bw.write("~ Wybrany " + spec + " ~");
		bw.newLine();
		bw.newLine();
		bw.write("Imię: " + Kot.kotki.get(k).getImie());
		bw.newLine();
		...
		bw.newLine();
		bw.newLine();
		bw.write("Imię: " + kandydat.getImie());
		bw.newLine();
